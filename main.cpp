...
int main(int argc, const char * argv[]) {
    ...
    */
    ...
    imwrite(image_folder_path + "original_gray_4_withbasicDENEMEEEE.jpg", original_gray_4_basic);
    
    Mat deneme = imread(image_folder_path + "original_gray_4_withbasicDENEMEEEE.jpg");
    
    deneme = deneme * 16;
    imshow("deneme", deneme);
